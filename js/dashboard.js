  ...
  function actualizarDashboard() {
   ...
   if (canvasElement && data.grafica) {
     ...
     if (
       ...
       window.miGraficaInstancia = new Chart(canvasElement.getContext("2d"), {
         type: "doughnut",
         data: {
           labels: etiquetas,
           datasets: [
      ...
      for (let mutation of mutationsList) {
        if (mutation.type === "childList") {
          ...
          if (node.nodeType === 1) {
            ...
            // --- TRUCO UX: Revisar si hay nota secreta y ejecutar el modal ---
...
if (elementoClickeado && elementoClickeado.getAttribute("data-menu-link")) {
  ...
  if (menuLink) {
    ...
    console.warn("El enlace del menú con ID '" + linkId + "' no existe aún.");
  }
}
    });
  }
