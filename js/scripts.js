...
document.getElementById('editar-passwordactual')?.addEventListener('input', (e) => e.target.classList.remove('input-error'));
...
document.getElementById('editar-password1')?.addEventListener('input', (e) => e.target.classList.remove('input-error'));
document.getElementById('editar-password2')?.addEventListener('input', (e) => e.target.classList.remove('input-error'));