...
<div class="container_dashboard_tablas" id="clientes">
    ...
    <div id="scroll-containerCli">
        ...
        <div id="crear-modalCliente" class="modal" style="display: none;">
            <div class="modal-content" style="width: 95%; max-width: 1100px; padding: 25px;">
                ...
                <form id="form-crearCliente" onsubmit="validarFormularioCliente(event, 'crear')" novalidate>
                        ...
                        <div class="seccion-form">
                            ...
                            <div class="form-containernum">
                                ...
                                <div class="form-group ladoble">
                                    ...
                                    <input type="text" name="codigo_postal" id="codigo_postal" title="Código postal" readonly style="background: #eef2f5;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="margin-top: 20px; text-align: right; border-top: 1px solid #ddd; padding-top: 15px;">
                        <button type="submit" class="boton-guardar"><i class="fa-solid fa-floppy-disk"></i> Guardar Cliente</button>
                        <span class="cancelarModal" onclick="cerrarModalCliente('crear-modalCliente')">Cancelar</span>
                    </div>
            ...
            <div class="modal-content" style="width: 95%; max-width: 1100px; padding: 25px;">
                ...
                <form id="form-editarCliente" novalidate>
                    ...
                    <div class="form-grid-3">
                        ...
                        <div class="seccion-form">
                            ...
                            <div class="form-containernum">
                                ...
                                <div class="form-group ladoble">
                                    <label for="codigo_postal">C.P.:</label>
                                    <input type="text" name="codigo_postal" id="editar-codigo_postal" readonly style="background: #eef2f5;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="margin-top: 20px; text-align: right; border-top: 1px solid #ddd; padding-top: 15px;">
                        ...
                        <span class="cancelarModal" onclick="cerrarModalCliente('editar-modalCliente')">Cancelar</span>
                    </div>
