...
if (isset($_SESSION['taller_id'])) {
  try {
    ...
    if ($tallerDB) {
      ...
      // Asumiendo que tienes un campo de correo en tu tabla talleres. 
      // Si no lo tienes, puedes omitir la línea del ReplyTo más abajo.
...
try {
  ...
  $mail->SMTPAuth   = true;
  $mail->Username   = 'swaos.mzt@gmail.com';
  $mail->Password   = 'mexm jeai hnig ygmo';
  $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
  $mail->Port       = 465;

  // EL TRUCO MULTIEMPRESA
  // El correo real de salida SIEMPRE es el tuyo, pero el nombre es dinámico
